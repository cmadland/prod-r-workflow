---
title: "Paradoxically Simpson"
subtitle: "Using pingwings to learn about data analysis and Quarto"
description: "This page is an output from the ‘Productive R Workflow’ course, by Yann Holtz."
format:
  html:
    code-fold: true
...
#| label: knitr-table
# Compute some result
bill_length_per_species <- df_clean_data %>% group_by(species) %>% 
  summarise(average_bill_length = mean(bill_length_mm, na.rm = TRUE))
